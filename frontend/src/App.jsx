  ...
  return (
    <div className="flex flex-col overflow-x-hidden">
      ...
      <div className='flex w-screen bg-yellow-300'>
        ...
        <div className='mr-12 flex space-x-12 justify-center items-center'>
        <a onClick={(event)=>{setCurrentComponent(components[0])}} href='#' className={` roboto rounded-md p-1  ${currentComponent == components[0] ? 'active': ''}  `}>Free Coins </a>
